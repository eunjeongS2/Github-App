...
data class User(val login: String, var name: String,
...
data class Event(val type: String, val actor: User, val repo: Repo, @field:SerializedName("created_at")val time: String)
